...
def design_primers(sequence, primer_len=20):
    ...
    return primers
def check_dimerization(primer1, primer2, threshold=4):
    """
...
def print_sequence_with_primer(sequence, primers, specific_primer=None):
    """
...
def main():
    ...
    reference_data = args.running_folder
